...
export function buildEndHTML(gzh) {
  ...
  switch (endStyle) {
    ...
    case 'pulse':
      // 脉冲：中心光点 + 双环雷达扩散
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-pulse-ring{0%{transform:scale(.3);opacity:.9}100%{transform:scale(1.7);opacity:0}}@keyframes gzh-pulse-dot{0%,100%{transform:scale(1)}50%{transform:scale(1.5)}}</style><section style="display:flex;align-items:center;justify-content:center;"><span style="display:inline-block;height:1px;width:52px;background:${line};"></span><span style="position:relative;display:inline-block;width:44px;height:24px;margin:0 16px;"><span style="position:absolute;left:50%;top:50%;margin:-6px 0 0 -6px;width:12px;height:12px;border-radius:50%;border:1px solid ${accent};box-sizing:border-box;animation:gzh-pulse-ring 2s ease-out infinite;"></span><span style="position:absolute;left:50%;top:50%;margin:-6px 0 0 -6px;width:12px;height:12px;border-radius:50%;border:1px solid ${accent};box-sizing:border-box;animation:gzh-pulse-ring 2s ease-out infinite;animation-delay:1s;"></span><span style="position:absolute;left:50%;top:50%;margin:-3px 0 0 -3px;width:6px;height:6px;border-radius:50%;background:${accent};animation:gzh-pulse-dot 2s ease-in-out infinite;"></span></span><span style="display:inline-block;height:1px;width:52px;background:${line};"></span></section></section>`;

    case 'scan':
      // 扫描：光束在线条上往复扫过
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-scan{0%{transform:translateX(0);opacity:0}12%{opacity:1}88%{opacity:1}100%{transform:translateX(176px);opacity:0}}</style><section style="display:flex;justify-content:center;"><span style="position:relative;display:inline-block;width:200px;height:2px;background:${line};border-radius:1px;"><span style="position:absolute;left:0;top:0;width:24px;height:2px;border-radius:1px;background:${accent};box-shadow:0 0 8px ${accent};animation:gzh-scan 2.2s ease-in-out infinite;"></span></span></section></section>`;

    case 'orbit':
      // 星轨：光点绕虚线轨道环绕
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-orbit{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@keyframes gzh-orbit-core{0%,100%{opacity:.4}50%{opacity:1}}</style><section style="display:flex;align-items:center;justify-content:center;"><span style="display:inline-block;height:1px;width:48px;background:${line};"></span><span style="position:relative;display:inline-block;width:22px;height:22px;margin:0 18px;border-radius:50%;border:1px dashed ${muted};box-sizing:border-box;"><span style="position:absolute;left:50%;top:50%;width:22px;height:22px;margin:-11px 0 0 -11px;animation:gzh-orbit 3s linear infinite;"><span style="position:absolute;left:50%;top:-3px;margin-left:-3px;width:6px;height:6px;border-radius:50%;background:${accent};box-shadow:0 0 6px ${accent};"></span></span><span style="position:absolute;left:50%;top:50%;margin:-2px 0 0 -2px;width:4px;height:4px;border-radius:50%;background:${muted};animation:gzh-orbit-core 3s ease-in-out infinite;"></span></span><span style="display:inline-block;height:1px;width:48px;background:${line};"></span></section></section>`;
    ...
    case 'breathe':
      // 灵晕：三层柔光圆盘涟漪式扩散，光核常驻呼吸
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-breathe-halo{0%{transform:scale(.3);opacity:.7}100%{transform:scale(1.6);opacity:0}}@keyframes gzh-breathe-core{0%,100%{transform:scale(.85);opacity:.8}50%{transform:scale(1.15);opacity:1}}</style><section style="display:flex;align-items:center;justify-content:center;"><span style="display:inline-block;height:1px;width:48px;background:${line};"></span><span style="position:relative;display:inline-block;width:40px;height:26px;margin:0 18px;"><span style="position:absolute;left:50%;top:50%;margin:-9px 0 0 -9px;width:18px;height:18px;border-radius:50%;background:radial-gradient(circle,${accent} 0%,transparent 70%);animation:gzh-breathe-halo 3s ease-out infinite;"></span><span style="position:absolute;left:50%;top:50%;margin:-9px 0 0 -9px;width:18px;height:18px;border-radius:50%;background:radial-gradient(circle,${accent} 0%,transparent 70%);animation:gzh-breathe-halo 3s ease-out infinite;animation-delay:1s;"></span><span style="position:absolute;left:50%;top:50%;margin:-9px 0 0 -9px;width:18px;height:18px;border-radius:50%;background:radial-gradient(circle,${accent} 0%,transparent 70%);animation:gzh-breathe-halo 3s ease-out infinite;animation-delay:2s;"></span><span style="position:absolute;left:50%;top:50%;margin:-5px 0 0 -5px;width:10px;height:10px;border-radius:50%;background:radial-gradient(circle,${accent} 20%,transparent 75%);animation:gzh-breathe-core 3s ease-in-out infinite;"></span></span><span style="display:inline-block;height:1px;width:48px;background:${line};"></span></section></section>`;
    ...
    case 'particle':
      // 粒子：星火自基线升腾熄灭
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-particle{0%{transform:translateY(0) scale(1);opacity:0}15%{opacity:1}100%{transform:translateY(-20px) scale(.3);opacity:0}}</style><section style="display:flex;justify-content:center;"><span style="position:relative;display:inline-block;width:150px;height:26px;"><span style="position:absolute;left:0;bottom:0;width:150px;height:1px;background:${line};"></span><span style="position:absolute;bottom:1px;left:20px;width:3px;height:3px;border-radius:50%;background:${accent};box-shadow:0 0 5px ${accent};animation:gzh-particle 2.4s ease-in infinite;animation-delay:0s;"></span><span style="position:absolute;bottom:1px;left:50px;width:3px;height:3px;border-radius:50%;background:${accent};box-shadow:0 0 5px ${accent};animation:gzh-particle 2.4s ease-in infinite;animation-delay:.5s;"></span><span style="position:absolute;bottom:1px;left:74px;width:4px;height:4px;border-radius:50%;background:${accent};box-shadow:0 0 6px ${accent};animation:gzh-particle 2.4s ease-in infinite;animation-delay:1.1s;"></span><span style="position:absolute;bottom:1px;left:100px;width:3px;height:3px;border-radius:50%;background:${accent};box-shadow:0 0 5px ${accent};animation:gzh-particle 2.4s ease-in infinite;animation-delay:.3s;"></span><span style="position:absolute;bottom:1px;left:128px;width:3px;height:3px;border-radius:50%;background:${accent};box-shadow:0 0 5px ${accent};animation:gzh-particle 2.4s ease-in infinite;animation-delay:.8s;"></span></span></section></section>`;

    case 'holo':
      // 全息：幻彩光带色相流转 + 扫描线纹理
      return `<section data-gzh-end style="margin:48px 10px 24px;"><style>@keyframes gzh-holo{0%{filter:hue-rotate(0deg)}100%{filter:hue-rotate(360deg)}}</style><section style="display:flex;justify-content:center;"><span style="position:relative;display:inline-block;width:160px;height:6px;border-radius:3px;overflow:hidden;background:linear-gradient(90deg,#22d3ee,#818cf8,#e879f9,#facc15,#22d3ee);animation:gzh-holo 4s linear infinite;"><span style="position:absolute;left:0;top:0;width:160px;height:6px;background:repeating-linear-gradient(0deg,rgba(255,255,255,.3) 0px,rgba(255,255,255,.3) 1px,transparent 1px,transparent 3px);"></span></span></section></section>`;
