...
export const theme = {
  ...
  gzh: {
    ...
    accent: '#ad6436', soft: '#f5f0e8', tagBg: '#efe6d9',
    headFont: SERIF,
    quoteStyle: 'warm',
    numStyle: 'plain'
  },
  styles: {
    ...
    h3: "font-size: 15px; font-weight: 800; color: #141413 !important; margin: 26px 10px 12px; padding-left: 12px; border-left: 3px solid #ad6436; line-height: 1.4 !important; font-family: Georgia, \"Songti SC\", \"Noto Serif SC\", serif;",
    ...
    blockquote: "margin: 0 10px 26px; padding: 16px 22px; background: #f5f0e8 !important; border-left: 4px solid #ad6436; font-size: 15px; color: #141413 !important; line-height: 1.85 !important; font-family: Georgia, \"Songti SC\", \"Noto Serif SC\", serif;",
    strong: "font-weight: 700; color: #ad6436 !important;",
    em: "font-style: italic; color: #3d3d3a !important;",
    a: "color: #ad6436 !important; font-weight: 600; text-decoration: none;",
    ...
    pre: "margin: 0 10px 26px; padding: 16px 18px; background: #18181B !important; color: #D4D4D8 !important; border-left: 3px solid #ad6436; border-radius: 6px; overflow-x: auto; font-size: 13px; line-height: 1.7 !important;",
