...
export const theme = {
  ...
  "styles": {
    ...
    "h6": "font-size: 15px; font-weight: 600; color: #74746d !important; line-height: 1.5 !important; margin: 12px 0 8px;",
    ...
    "em": "font-style: italic; color: #74746d !important;",
    "a": "color: #be3f32  !important; text-decoration: none; background: rgba(26, 26, 24, 0.06); padding: 1px 5px; border-radius: 3px;",
    ...
    "pre": "margin: 14px 0; padding: 20px; background: rgba(26, 26, 24, 0.06) !important; font-family: 'JetBrains Mono', 'SF Mono', Menlo, Consolas, monospace; font-size: 13px; border-radius: 8px; overflow-x: auto; line-height: 1.6 !important; color: #0073a0 !important;",
