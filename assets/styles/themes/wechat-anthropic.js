...
export const theme = {
  ...
  "styles": {
    ...
    "h1": "font-size: 24px; font-weight: 600; color: #ae5636 !important; line-height: 1.15 !important; margin: 32px 0 24px; letter-spacing: -0.025em; background: linear-gradient(135deg, #ae5636 0%, #e97d5b 50%, #CC8B7A 100%); -webkit-background-clip: text; background-clip: text;",
    "h2": "font-size: 22px; font-weight: 600; color: #ae5636 !important; line-height: 1.25 !important; margin: 40px 0 20px; letter-spacing: -0.02em; background: linear-gradient(135deg, #ae5636 0%, #9DC88D 100%); -webkit-background-clip: text; background-clip: text;",
    ...
    "strong": "font-weight: 500; color: #ae5636 !important; background-color: rgba(174, 86, 54, 0.08) !important; padding: 2px 6px; border-radius: 3px;",
    "em": "font-style: italic; color: #5a5a5a !important;",
    "a": "color: #ae5636 !important; text-decoration: none; border-bottom: 1px solid rgba(174, 86, 54, 0.4); font-weight: 500;",
    ...
    "blockquote": "margin: 24px 0; padding: 12px 18px; background: linear-gradient(135deg, rgba(174, 86, 54, 0.06) 0%, rgba(157, 200, 141, 0.06) 100%); border-left: 4px solid #ae5636; color: #2b2b2b !important; font-size: 15px; line-height: 1.55 !important; font-style: italic; border-radius: 8px;",
